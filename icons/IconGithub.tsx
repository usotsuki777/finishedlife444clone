    ...
    return (
        <>
            <svg fill="currentColor" viewBox="0 0 24 24"
                className="w-10 h-10 text-gray-700 hover:text-gray-500 mr-3 text-opacity-50 transform filter drop-shadow-lg transition duration-500 hover:-translate-y-1 hover:scale-125">
